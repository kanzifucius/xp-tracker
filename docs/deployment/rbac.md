...
This permissive rule is convenient for getting started but should be scoped down for production.
...
You can override the ClusterRole via a Kustomize patch in your overlay:
